...
```
![in_comp_if](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/gtkwave_incomp_if.png)

---

### Lab 2: Synthesis Result of Lab 1

![incomp_synth](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/yosys_incomp_if.png)
...
```
![icomp2](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/gtkwave_incomp_if2.png)

---

### Lab 4: Synthesis Result of Lab 3

![incomp2synth](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/yosys_incomp_if2.png)
...
```
![compcase](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/gtkwave_comp_case.png)

---

### Lab 6: Synthesis Result of Lab 5

![compcase_synth](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/yosys_comp_case.png)
...
```
![badcase](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/yosys_incomp_case.png)
...
```
![Screenshot_2025-05-28_12-39-30](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/yosys_partial_case.png)

> **Note:** Steps to perform the above labs are shown in [Day 1](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/tree/main/Week1/Day1).
...
```
![mux_generate](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/gtkwave_mux.png)
...
```
![demux-case](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/gtkwave_demux_case.png)
...
```
![demux-generate](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/gtkwave_demux.png)
...
```
![rca_org](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day5/gtkwave_rca.png)

---

> **Note:** Steps to perform the above labs are already shown in [Day 1](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/tree/main/Week1/Day1).
