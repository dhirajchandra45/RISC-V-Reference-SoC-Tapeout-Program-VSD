...
Follow the steps from [Day 1 Synthesis Lab](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/tree/main/Week1/Day1#6-synthesis-lab-with-yosys) and add the following between `abc -liberty` and `synth -top`:
```shell
opt_clean -purge
```

![Lab 1 Output](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day3/opt_check.png)
...
![Lab 2 Output](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day3/opt_check2.png)
...
![Lab 3 Output](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day3/opt_check3.png)
...
![Lab 4 Output](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day3/opt_check4.png)
...
![Lab 5 Output](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day3/dff_const1.png)
...
![Lab 6 Output](https://github.com/dhirajchandra45/RISC-V-Reference-SoC-Tapeout-Program-VSD/blob/main/Week1/Day3/dff_const2.png)
